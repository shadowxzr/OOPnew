...
partial class FormShip
{
	...
	private void InitializeComponent()
	{
		...
		buttonCreateBattleship.Size = new Size(100, 30);
		...
		buttonCheckBorders.Location = new Point(230, 562);
		...
		buttonMovementStep.Location = new Point(360, 562);
		...
		comboBoxDestination.Location = new Point(470, 565);
		...
		Name = "FormShip";
		Text = "Линкор - Лабораторная работа №2";
